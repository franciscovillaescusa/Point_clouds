...
- **Quijote**. These are dark matter halos from cosmological N-body simulations that only account for gravity. They sample a big volume and contain some of the largest halos in their respective universes. Each Quijote simulations contains around 100,000 dark matter halos. [Link to data](https://users.flatironinstitute.org/~fvillaescusa/Graphs4Science/Quijote/).
- **CAMELS-SAM**. These are galaxies obtained by combining cosmological N-body simulations with semi-analytics models of galaxy formation. The sample a volume 1000x smaller than Quijote but their galaxies are quite representative of the standard galaxies observed in the universe. [Link to data](https://users.flatironinstitute.org/~fvillaescusa/Graphs4Science/CAMELS-SAM/).
